...
class _PlanScreenState extends State<PlanScreen> {
  ...
  Widget build(BuildContext context) {
    ValueNotifier<List<Plan>> plansNotifier = PlanProvider.of(context) as ValueNotifier<List<Plan>>;
    return Scaffold(
  ...
  Widget _buildAddTaskButton(BuildContext context) {
    ValueNotifier<List<Plan>> planNotifier = PlanProvider.of(context) as ValueNotifier<List<Plan>>;
